    ...
    return (
      <StyledContainer>
        <svg className="milk-404" viewBox="0 0 500 500">
          ...
          <g id="milk-face">
            <path id="mouth" fill="none" stroke="#4f3e7c" strokeLinecap="round" strokeMiterlimit="10" strokeWidth="4" d="M338.4 239.8l32-3.9"/>
            {/* <path id="mouth-smile" fill="none" stroke="#4f3e7c" strokeLinecap="round" strokeMiterlimit="10" strokeWidth="4" d="M341.1 240.5s15.4 10.5 27.3-3.5"/> */}
            <path id="mouth-frown" fill="none" stroke="#4f3e7c" strokeLinecap="round" strokeMiterlimit="10" strokeWidth="4" d="M368.4 240.8s-15.4-10.5-27.3 3.5"/>
            <g id="eyes">
